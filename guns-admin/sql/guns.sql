...
CREATE TABLE `t_user_info` (
  `uid` BIGINT(16) NOT NULL AUTO_INCREMENT COMMENT '用户ID',
  `user_name` VARCHAR(32) COLLATE utf8_bin DEFAULT NULL COMMENT '用户名',
  `user_qq` VARCHAR(16) COLLATE utf8_bin DEFAULT NULL COMMENT '用户的qq （账号）',
  `user_password` VARCHAR(34) COLLATE utf8_bin DEFAULT NULL COMMENT '用户的密码',
  `integral` BIGINT(16) DEFAULT NULL COMMENT '用户的积分',
  `recommend_user` BIGINT(16) DEFAULT NULL COMMENT '推荐用户',
  PRIMARY KEY (`uid`)
) ENGINE=INNODB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin


CREATE TABLE `t_user_history_statistics` (
  `id` BIGINT(16) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `game_id` BIGINT(16) NOT NULL COMMENT '游戏ID',
  `period` VARCHAR(32) COLLATE utf8_bin NOT NULL COMMENT '第多少期',
  `sum_count` FLOAT NOT NULL COMMENT '总压',
  `big_count` FLOAT NOT NULL COMMENT '压大',
  `small_count` FLOAT NOT NULL COMMENT '压小',
  `single_count` FLOAT NOT NULL COMMENT '压单',
  `double_count` FLOAT NOT NULL COMMENT '压双',
  `big_single_count` FLOAT NOT NULL COMMENT '压大单',
  `big_double_count` FLOAT NOT NULL COMMENT '压大双',
  `small_single_count` FLOAT NOT NULL COMMENT '压小单',
  `small_double_count` FLOAT NOT NULL COMMENT '压小双',
  `couplet_count` FLOAT NOT NULL COMMENT '压对子',
  `along_count` FLOAT NOT NULL COMMENT '压顺子',
  `leopard_count` FLOAT NOT NULL COMMENT '压豹子',
  `count_0` FLOAT NOT NULL COMMENT '0',
  `count_1` FLOAT NOT NULL COMMENT '1',
  `count_2` FLOAT NOT NULL COMMENT '2',
  `count_3` FLOAT NOT NULL COMMENT '3',
  `count_4` FLOAT NOT NULL COMMENT '4',
  `count_5` FLOAT NOT NULL COMMENT '5',
  `count_6` FLOAT NOT NULL COMMENT '6',
  `count_7` FLOAT NOT NULL COMMENT '7',
  `count_8` FLOAT NOT NULL COMMENT '8',
  `count_9` FLOAT NOT NULL COMMENT '9',
  `count_10` FLOAT NOT NULL COMMENT '10',
  `count_11` FLOAT NOT NULL COMMENT '11',
  `count_12` FLOAT NOT NULL COMMENT '12',
  `count_13` FLOAT NOT NULL COMMENT '13',
  `count_14` FLOAT NOT NULL COMMENT '14',
  `count_15` FLOAT NOT NULL COMMENT '15',
  `count_16` FLOAT NOT NULL COMMENT '16',
  `count_17` FLOAT NOT NULL COMMENT '17',
  `count_18` FLOAT NOT NULL COMMENT '18',
  `count_19` FLOAT NOT NULL COMMENT '19',
  `count_20` FLOAT NOT NULL COMMENT '20',
  `count_21` FLOAT NOT NULL COMMENT '21',
  `count_22` FLOAT NOT NULL COMMENT '22',
  `count_23` FLOAT NOT NULL COMMENT '23',
  `count_24` FLOAT NOT NULL COMMENT '24',
  `count_25` FLOAT NOT NULL COMMENT '25',
  `count_26` FLOAT NOT NULL COMMENT '26',
  `count_27` FLOAT NOT NULL COMMENT '27',
  `user_id` BIGINT(16) DEFAULT NULL COMMENT '用户ID',
  `count_sub` FLOAT DEFAULT NULL COMMENT '最终结果',
  PRIMARY KEY (`id`)
) ENGINE=MYISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin


CREATE TABLE `t_period_odds` (
  `id` bigint(16) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `period` varchar(32) COLLATE utf8_bin NOT NULL COMMENT '第多少期',
  `num_of_people` float NOT NULL COMMENT '参与人数',
  `big_odds` float NOT NULL COMMENT '大的赔率',
  `small_odds` float NOT NULL COMMENT '小的赔率',
  `single_odds` float NOT NULL COMMENT '单的统计',
  `double_odds` float NOT NULL COMMENT '双的统计',
  `big_single_odds` float NOT NULL COMMENT '大单的统计',
  `big_double_odds` float NOT NULL COMMENT '大双的统计',
  `small_single_odds` float NOT NULL COMMENT '小单的统计',
  `small_double_odds` float NOT NULL COMMENT '小双的统计',
  `couplet_odds` float NOT NULL COMMENT '对子的统计',
  `along_odds` float NOT NULL COMMENT '顺子的统计',
  `leopard_odds` float NOT NULL COMMENT '豹子的统计',
  `odds_0` float NOT NULL COMMENT '0',
  `odds_1` float NOT NULL COMMENT '1',
  `odds_2` float NOT NULL COMMENT '2',
  `odds_3` float NOT NULL COMMENT '3',
  `odds_4` float NOT NULL COMMENT '4',
  `odds_5` float NOT NULL COMMENT '5',
  `odds_6` float NOT NULL COMMENT '6',
  `odds_7` float NOT NULL COMMENT '7',
  `odds_8` float NOT NULL COMMENT '8',
  `odds_9` float NOT NULL COMMENT '9',
  `odds_10` float NOT NULL COMMENT '10',
  `odds_11` float NOT NULL COMMENT '11',
  `odds_12` float NOT NULL COMMENT '12',
  `odds_13` float NOT NULL COMMENT '13',
  `odds_14` float NOT NULL COMMENT '14',
  `odds_15` float NOT NULL COMMENT '15',
  `odds_16` float NOT NULL COMMENT '16',
  `odds_17` float NOT NULL COMMENT '17',
  `odds_18` float NOT NULL COMMENT '18',
  `odds_19` float NOT NULL COMMENT '19',
  `odds_20` float NOT NULL COMMENT '20',
  `odds_21` float NOT NULL COMMENT '21',
  `odds_22` float NOT NULL COMMENT '22',
  `odds_23` float NOT NULL COMMENT '23',
  `odds_24` float NOT NULL COMMENT '24',
  `odds_25` float NOT NULL COMMENT '25',
  `odds_26` float NOT NULL COMMENT '26',
  `odds_27` float NOT NULL COMMENT '27',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin


CREATE TABLE `t_game_odds` (
  `id` bigint(16) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `big_odds` float NOT NULL COMMENT '大的赔率',
  `small_odds` float NOT NULL COMMENT '小的赔率',
  `single_odds` float NOT NULL COMMENT '单的赔率',
  `double_odds` float NOT NULL COMMENT '双的赔率',
  `big_single_odds` float NOT NULL COMMENT '大单的赔率',
  `big_double_odds` float NOT NULL COMMENT '大双的赔率',
  `small_single_odds` float NOT NULL COMMENT '小单的赔率',
  `small_double_odds` float NOT NULL COMMENT '小双的赔率',
  `couplet_odds` float NOT NULL COMMENT '对子的赔率',
  `along_odds` float NOT NULL COMMENT '顺子的赔率',
  `leopard_odds` float NOT NULL COMMENT '豹子的赔率',
  `odds_0` float NOT NULL COMMENT '0',
  `odds_1` float NOT NULL COMMENT '1',
  `odds_2` float NOT NULL COMMENT '2',
  `odds_3` float NOT NULL COMMENT '3',
